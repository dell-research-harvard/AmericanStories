from stages.images_to_layouts import LayoutModel, LineModel, Predictor, FeatureSavingGeneralizedRCNN, BackboneClassifierHead
from stages.layouts_to_text import Layouts, LayoutObject, CustomManager
...
if __name__ == '__main__':
    ...
    parser.add_argument('--effocr_timm_auto_model', default=None,
        help="Timm encoder to use, matches model the localizer was finetuned with localizer")
    ...
    parser.add_argument("--device", default='cuda',
        help="")
    parser.add_argument("--spell_checks", action='extend', nargs='*', default=[],
        choices=['symspell', 'effocr_visual'], help="State which spell checking methods to apply to the output")
    ...
    homoglyphs_path = args.spell_check_homoglyphs_path
    spell_checks = args.spell_checks
    ...
    layouts = Layouts(
        ...
        homoglyphs_path=homoglyphs_path
    )
